...
page 377  "And the plotting code is exactly the same as before (page 297).": Page 301 has the code for plotting the posterior predictions for a single actor, while the code on 297 plots only average posterior predictions for models that ignore actor.
